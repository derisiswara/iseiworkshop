...
| 1 | 08.30 – 10.15 | **Pengantar R, Pengolahan Data, dan Visualisasi** <br> [Tayangan Teori Prof Firdaus](PengenalaRStudio2026.pdf) <br> [Praktik Deri Siswara](01-intro.html) | Pengenalan RStudio, tipe data, import data, manipulasi data dengan tidyverse, visualisasi dengan ggplot2, dan statistik deskriptif. | [📄 R Script Deri Siswara](01-intro-script.R) <br> [📊 Data WVS 1](data/regresi/wvs1.xlsx) <br> [📊 Data WVS 2](data/regresi/wvs2.xlsx) |
