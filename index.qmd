...
| 3 | 13.00 – 15.30 | [**Structural Equation Modelling (SEM)**](03-sem.html) | CB-SEM dengan `lavaan` (CFA, full SEM, mediasi) dan PLS-SEM dengan `seminr` (model ECSI, bootstrap, PLS-Predict). |
