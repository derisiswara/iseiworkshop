...
| 2 | 10.30 – 12.00 | **Analisis Regresi** <br> [Tayangan Prof Firdaus](Pengantar Regresi dengan RStudio 2026.pdf) <br> [Tayangan Praktik Deri Siswara](02-regresi.html) | Regresi linear sederhana, berganda, dan dengan variabel kategorikal menggunakan data WVS. Diagnostik model dan interpretasi hasil. | [📄 R Script Deri Siswara](02-regresi-script.R) <br> 📊 Masih menggunakan data WVS <br> [📄 R Script Fahmi](Analisis Regresi.R) <br> [📊 Data Regresi Fahmi](data/regresi/Data Analisis Regresi.xlsx) |
| \~ | 12.00 – 13.00 | 🍽️ *Makan Siang* | | |
| 3 | 13.00 – 15.30 | **Structural Equation Modelling (SEM)** <br> [Tayangan Prof Firdaus](SEM dengan RStudio 2026.pdf) <br> [Tayangan Praktik Deri Siswara](03-sem.html) | | [📄 R Script Deri](03-sem-script.R) <br> [📊 Data SEM Deri](data/sem/data.xlsx) <br> [📄 R Script Fahmi 1](script SEM.R) <br> [📊 Data Fahmi 1](data/sem/datasem.xlsx) <br> [📄 R Script Fahmi 2](syntax SEM original.R) <br> [📊 Data Fahmi 2](data/sem/datasem0.xlsx) |
