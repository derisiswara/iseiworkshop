...
::: table-schedule
| Sesi | Waktu | Materi | Deskripsi | Unduh |
|------------------|------------------|------------------|--------------------|------------------|
| \~ | Sebelum workshop | Persiapan | Selesaikan [kegiatan pra-workshop](#kegiatan-pra-workshop) | |
| 1 | 08.30 – 10.15 | **Pengantar R, Pengolahan Data, dan Visualisasi** <br> [Tayangan Teori Prof Firdaus](Pengenalan RStudio  2026.pdf) <br> [Praktik Deri Siswara](01-intro.html) | Pengenalan RStudio, tipe data, import data, manipulasi data dengan tidyverse, visualisasi dengan ggplot2, dan statistik deskriptif. | [📄 R Script Deri Siswara](01-intro-script.R) <br> [📊 Data WVS 1](data/regresi/wvs1.xlsx) <br> [📊 Data WVS 2](data/regresi/wvs2.xlsx) |
| \~ | 10.15 – 10.30 | ☕ *Coffee Break* | | |
| 2 | 10.30 – 12.00 | **Analisis Regresi** <br> [Tayangan Prof Firdaus](Pengantar Regresi dengan RStudio 2026.pdf) <br> [Tayangan Praktik Deri Siswara](02-regresi.html) | Versi Deri mencakup regresi linear sederhana, berganda, dan penggunaan variabel kategorikal menggunakan data WVS, lengkap dengan diagnostik model serta interpretasi hasil. Versi Fahmi menyajikan aplikasi pada data ekonomi yang melibatkan transformasi logaritma untuk interpretasi elastisitas. | [📄 R Script Deri Siswara](02-regresi-script.R) <br> 📊 Masih menggunakan data WVS <br> [📄 R Script Fahmi](Analisis Regresi.R) <br> [📊 Data Regresi Fahmi](data/regresi/Data Analisis Regresi.xlsx) |
| \~ | 12.00 – 13.00 | 🍽️ *Makan Siang* | | |
| 3 | 13.00 – 15.30 | **Structural Equation Modelling (SEM)** <br> [Tayangan Prof Firdaus](SEM dengan RStudio 2026.pdf) <br> [Tayangan Praktik Deri Siswara](03-sem.html) | Versi Deri menyediakan materi fundamental SEM, mencakup CB-SEM menggunakan package `lavaan` dan PLS-SEM dengan package `seminr`. Versi Fahmi menyajikan latihan dasar SEM menggunakan data riil. | [📄 R Script Deri](03-sem-script.R) <br> [📊 Data SEM Deri](data/sem/data.xlsx) <br> [📄 R Script Fahmi 1](script SEM.R) <br> [📊 Data Fahmi 1](data/sem/datasem.xlsx) <br> [📄 R Script Fahmi 2](syntax SEM original.R) <br> [📊 Data Fahmi 2](data/sem/datasem0.xlsx) |
...
<style type="text/css">
    ...
    .table-schedule th:nth-child(1), .table-schedule td:nth-child(1) { width: 6%; }
    .table-schedule th:nth-child(2), .table-schedule td:nth-child(2) { width: 13%; }
    .table-schedule th:nth-child(3), .table-schedule td:nth-child(3) { width: 25%; }
    .table-schedule th:nth-child(4), .table-schedule td:nth-child(4) { width: 36%; }
    .table-schedule th:nth-child(5), .table-schedule td:nth-child(5) { width: 20%; }
</style>
```
...
2.  Salin kode berikut: `install.packages(c("readxl", "car", "broom", "lmtest", "sandwich", "lavaan", "semPlot", "seminr", "tidyverse", "rmarkdown", "knitr"))`
